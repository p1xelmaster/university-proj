...
public final class PanMaratCourseSpecification {

    private PanMaratCourseSpecification() {
    }

    public static Specification<PanMaratCourse> withFilters(PanMaratCourseSearchForm form) {

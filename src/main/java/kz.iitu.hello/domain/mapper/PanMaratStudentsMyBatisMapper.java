...
@Mapper
public interface PanMaratStudentsMyBatisMapper {
    ...
    List<PanMaratStudent> findStudents(@Param("name") String name,
    ...
    @Select("""
        ...
        WHERE id = #{id}
        """)
    PanMaratUser findUserById(Long id);
    ...
    @Select("""
        ...
        """)
    List<PanMaratCourse> findCoursesByStudentId(Long studentId);
